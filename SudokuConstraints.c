...
/*****************************************************************************/
/*                   Define constraints for grid completion                  */
/*****************************************************************************/

/*
** Validation function. Returns false if any square is VALUE_NONE.
*/
bool GridComplete(Grid grid, Region* region)
{
    unsigned int locationIndex = 0;
    GridLocation* locations = region->locations;
...
GridLocation WHOLE_GRID[] = {   { ROW_0, COL_0 }, { ROW_0, COL_1 }, { ROW_0, COL_2 }, { ROW_0, COL_3 }, { ROW_0, COL_4 }, { ROW_0, COL_5 }, { ROW_0, COL_6 }, { ROW_0, COL_7 }, { ROW_0, COL_8 },
...
#define REGION_WHOLE_GRID { WHOLE_GRID, sizeof(WHOLE_GRID) / sizeof(WHOLE_GRID[0]) }

#define CONSTRAINT_WHOLE_GRID { REGION_WHOLE_GRID, GridComplete }

Constraint wgCon[] = { CONSTRAINT_WHOLE_GRID };

ConstraintList gridCompleteConstraints = { wgCon, sizeof(wgCon) / sizeof(wgCon[0]) };
